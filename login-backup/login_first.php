...
<body class="rounded-lg color-changing flex justify-center items-center min-h-screen">
    ...
    <div class="flex justify-center items-center mt-6 space-x-4">
            <img src="https://via.placeholder.com/80" alt="Profile" class="rounded-full w-20 h-20 border-2 border-gray-300">
        </div>
        ...
        <div class="flex justify-center items-center mt-4 space-x-6 ">
            <a href="https://facebook.com" class="text-blue-600 text-3xl hover hover:scale-110  transition duration-300">
                <i class='bx bxl-facebook'></i>
            </a>
            <a href="https://instagram.com" class="text-pink-500 text-3xl hover hover:scale-110  transition duration-300">
                <i class='bx bxl-instagram'></i>
            </a>
            <a href="https://youtube.com" class="text-red-600 text-3xl hover hover:scale-110  transition duration-300">
                <i class='bx bxl-youtube'></i>
            </a>
            <a href="https://wa.me" class="text-green-500 text-3xl hover hover:scale-110  transition duration-300">
